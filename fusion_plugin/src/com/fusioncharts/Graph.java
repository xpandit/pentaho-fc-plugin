...
implements Cloneable, Comparable<Graph>
{
  ...
  ***************************************************************************/
  ...
  throws IllegalArgumentException
  {
    ...
    this.categories = new String[length];
  ...
  ***************************************************************************/
  ...
  {
    for (int i = 0, its = Math.min(this.categories.length,category.length); i < its; i++)
  ...
  ***************************************************************************/
  ...
  throws IndexOutOfBoundsException, IllegalArgumentException
  {
    ...
    //length of series is = to the category length
    series = new Series(label,this.categories.length);
...
public Object clone()
  throws CloneNotSupportedException
  {
    ...
    clonedObject.categories = new String[this.categories.length];
    System.arraycopy(this.categories,0,clonedObject.categories,0,this.categories.length);
