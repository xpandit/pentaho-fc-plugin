/*
* sub class of the Chart class for the SeriesColumn charts
*
*/
define([
	'cdf/lib/jquery',
	...
	'amd!cdf/lib/underscore'
		...
		function SeriesColumn(name, width, height, chartType, htmlObject) {
		...
		// extend Chart class
		SeriesColumn.prototype = Object.create(Chart.prototype);

		SeriesColumn.prototype = {
			...
			setBuildChartSeriesColumn: function (chartDefinition, values) {
				var cd = chartDefinition;

				var queryDataset = ChartUtils.prototype.buildGroupedColumnData(values,'seriesname','data','value');
				...
				if (_.has(cd, 'dataSetProperties')) {
					...
					if(_.has(cd.dataSetProperties, 'dataCallback')){queryDataset = ChartUtils.prototype.applyGroupedCallBack(queryDataset,cd.dataSetProperties.dataCallback,'seriesname','data');};
			 	}
